 ...
 *
 */
package net.mcreator.insectsandarthropods;
...
@Mod("insects_and_arthropods")
public class InsectsAndArthropodsMod {
	public static final Logger LOGGER = LogManager.getLogger(InsectsAndArthropodsMod.class);
	public static final String MODID = "insects_and_arthropods";
